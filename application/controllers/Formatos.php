    ...
    public function firmado(){
        ...
        if (!$cert) {
            ...
            if (isset($response_soap->error)) {
                ...
                $response->code = 500;
                echo "<center><h3>Lo sentimos estamos teniendo problemas técnicos temporalmente; estamos trabajando para resolver esta situación los mas pronto posible, por favor intenta de nuevo mas tarde  :(</center></h3>";
                die();
            } else {
       ...
       if(!$licencia){
           ...
           if($licencia->folio_licencia == 0){
               $params = array(
                   ...
                   'propietario'=> strtoupper($nombre),
                   'primer_ap'=> strtoupper($apellido_primer),
                   'segundo_ap'=> strtoupper($apellido_segundo),
                   'rfc'=>strtoupper($rfc),
                   ...
                   'num_ext'=>$no_ext,
                   'let_ext'=>strtoupper($licencia->st3_letra_ext_establecimiento),
                   'num_int'=>$no_int,
                   'let_int'=>strtoupper($licencia->st3_letra_int_establecimiento),
