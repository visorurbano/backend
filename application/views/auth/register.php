<div class="auth">
    ...
    <form id="frmRegister" class="mui-form">
        <div class="mui-textfield mui-textfield--float-label">
            <input type="text" id="txtNombre" name="nombre" class="input-material" required>
            <label for="txtNombre">*Nombre(s)</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="text" id="txtApePat" name="ape_paterno" class="input-material" required>
            <label for="txtApePat">*Primer Apellido</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="text" id="txtApeMat" name="ape_materno" class="input-material">
            <label for="txtApeMat">Segundo Apellido</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="email" id="txtEmail" name="email" class="input-material" required>
            <label for="txtEmail">*Correo Electrónico</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="text" id="txtCelular" name="celular" id="txtCelular" maxlength="10" class="input-material" required>
            <label for="txtCelular">*Número celular</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="password" name="password" id="password" class="input-material" required>
            <label for="password">*Contraseña</label>
        </div>
        <div class="mui-textfield mui-textfield--float-label">
            <input type="password" name="repassword" class="input-material" required>
            <label for="repassword">*Confirmar contraseña</label>
        </div>
        <!--<div class="form-group">
            <div class="g-recaptcha" data-sitekey="6Lf-VzMUAAAAAJLm3wzF4HcYMtU4lShUahX6YuV8"></div>
        </div>-->
        <br>
        <div class="mui-checkbox">
            <label>
                <input type="checkbox" name="agree" value="agree" required class="checkbox-template"/>
                He leído y aceptó los <a href="#" data-toggle="modal" data-target="#mdlTerminosCondiciones">terminos y condiciones</a>
            </label>
        </div>
        <br>
        <center>
            <button type="button" id="btnRegistro" class="mui-btn mui-btn--primary">Registrarme</button>
        </center>&nbsp;
        <!--<a href="<?=base_url()?>ingresar" class="mui-btn mui-btn--danger">Regresar</a>-->
    </form>
</div>
