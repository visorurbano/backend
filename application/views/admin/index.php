                    ...
                    <?php foreach($licencias as $licencia): ?>
                        <div class="project">
                            <div class="row bg-white has-shadow">
                                <div class="left-col col-lg-<?php if($licencia->status !='FP'){echo 10;}else{echo 8;}?> d-flex align-items-center justify-content-between">
                                ...
                                <div class="right-col col-lg-<?php if($licencia->status !='FP'){echo 2;}else{echo 4;}?> d-flex align-items-center">
